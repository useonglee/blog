...
inquirer
  ...
  .then((answers) => {
    ...
    else if (!fs.existsSync('data/review')) fs.mkdirSync('data/review', { recursive: true })

    const blogFilePath = `data/blog/${fileName ? fileName : 'untitled'}.${
    ...
    const filePath = blogFilePath === 'data/blog/untitled.md' ? reviewFilePath : blogFilePath
