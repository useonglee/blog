...
/* harmony import */ var _review__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(14);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_review__WEBPACK_IMPORTED_MODULE_5__, _lib_mdx__WEBPACK_IMPORTED_MODULE_3__]);
([_review__WEBPACK_IMPORTED_MODULE_5__, _lib_mdx__WEBPACK_IMPORTED_MODULE_3__] = __webpack_async_dependencies__.then ? await __webpack_async_dependencies__ : __webpack_async_dependencies__);
...
async function getStaticPaths() {
    const totalPosts = await (0,_lib_mdx__WEBPACK_IMPORTED_MODULE_3__/* .getAllFilesFrontMatter */ .sj)('review');
    const totalPages = Math.ceil(totalPosts.length / _review__WEBPACK_IMPORTED_MODULE_5__.POSTS_PER_PAGE);
...
async function getStaticProps(context) {
    ...
    const posts = await (0,_lib_mdx__WEBPACK_IMPORTED_MODULE_3__/* .getAllFilesFrontMatter */ .sj)('review');
    const pageNumber = parseInt(page);
    const initialDisplayPosts = posts.slice(_review__WEBPACK_IMPORTED_MODULE_5__.POSTS_PER_PAGE * (pageNumber - 1), _review__WEBPACK_IMPORTED_MODULE_5__.POSTS_PER_PAGE * pageNumber);
    const pagination = {
        currentPage: pageNumber,
        totalPages: Math.ceil(posts.length / _review__WEBPACK_IMPORTED_MODULE_5__.POSTS_PER_PAGE)
    };
    return {
        props: {
            posts,
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,373,59,590,717,795,14], () => (__webpack_exec__(7940)));
