...
async function getStaticPaths() {
    const blogTags = await (0,_lib_tags__WEBPACK_IMPORTED_MODULE_6__/* .getAllTags */ .Y)('blog');
    const reviewTags = await (0,_lib_tags__WEBPACK_IMPORTED_MODULE_6__/* .getAllTags */ .Y)('review');
    const tags = {
        ...blogTags,
        ...reviewTags
    };
...
async function getStaticProps({ params  }) {
    const blogAllPosts = await (0,_lib_mdx__WEBPACK_IMPORTED_MODULE_5__/* .getAllFilesFrontMatter */ .sj)('blog');
    const reviewAllPosts = await (0,_lib_mdx__WEBPACK_IMPORTED_MODULE_5__/* .getAllFilesFrontMatter */ .sj)('review');
    const allPosts = [
        ...blogAllPosts,
        ...reviewAllPosts
    ];
